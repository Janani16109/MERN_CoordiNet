...
const TopPerformers = () => {
  ...
  return (
    <Paper elevation={0} className="glass-soft" sx={{ p: 3, borderRadius: 2 }}>
      ...
      <Typography variant="body2" sx={{ color: 'rgba(255,255,255,0.72)' }} paragraph>
                ...
                secondary={
                  <React.Fragment>
                    <Grid container spacing={2} sx={{ mt: 1 }}>
                      <Grid item xs={12} sm={6}>
                        <Box display="flex" alignItems="center">
                          <SchoolIcon fontSize="small" sx={{ mr: 1, color: 'rgba(255,255,255,0.6)' }} />
                      ...
                      <Grid item xs={12} sm={6}>
                        <Box display="flex" alignItems="center">
                          <EmojiEventsIcon fontSize="small" sx={{ mr: 1, color: 'rgba(255,255,255,0.6)' }} />
                          <Typography variant="body2" sx={{ color: 'rgba(255,255,255,0.72)' }}>
                    ...
                    <Box display="flex" alignItems="center" mt={1}>
                      <Typography 
                        variant="h6" 
                        sx={{ color: 'var(--color-accent)', fontWeight: '700', mr: 2 }}
                      >
