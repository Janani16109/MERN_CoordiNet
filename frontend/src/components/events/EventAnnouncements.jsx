...
const EventAnnouncements = ({ eventId, eventTitle }) => {
  ...
  return (
    <Paper elevation={0} className="glass-soft" sx={{ p: 3, mt: 3 }}>
      ...
      {error && (
        <Alert className="glass-soft" severity="error" sx={{ mb: 3 }}>
          {error}
        </Alert>
      )}
      ...
      {/* Create/Edit Announcement Dialog */}
          <Dialog open={openDialog} onClose={handleCloseDialog} maxWidth="md" fullWidth PaperProps={{ className: 'glass-soft' }}>
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12}>
                    <FormControl fullWidth>
                      ...
                      >
                        <MenuItem sx={{ color: 'rgba(255,255,255,0.95)' }} value="low">Low</MenuItem>
                        <MenuItem sx={{ color: 'rgba(255,255,255,0.95)' }} value="medium">Medium</MenuItem>
                        <MenuItem sx={{ color: 'rgba(255,255,255,0.95)' }} value="high">High</MenuItem>
                      </Select>
                    </FormControl>
                  </Grid>
                </Grid>
            ...
            <DialogActions>
              <Button onClick={handleCloseDialog} sx={{ color: 'rgba(255,255,255,0.9)' }}>Cancel</Button>
